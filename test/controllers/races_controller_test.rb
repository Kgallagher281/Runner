...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { address: @race.address, date: @race.date, details: @race.details, distance: @race.distance, name: @race.name } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { address: @race.address, date: @race.date, details: @race.details, distance: @race.distance, name: @race.name } }
